...
<section>
    ...
    <div class="items-header">
        ...
        <div class="search-wrapper ">
            ...
            <form action="{{ route('nhomdoituong.index') }}" method="GET">
                <div class="search">
                    <i class="fa-solid fa-magnifying-glass search-icon"></i>
                    <input type="text" name="search" id="search" placeholder="Tìm kiếm" class="search-bar"
    ...
    <table>
        ...
        <tbody>
            @foreach ($grouped as $loaiNhom => $nhomDoiTuongs)
                <tr class="group-header">
                    <td colspan="3">Nhóm đối tượng: {{ $loaiNhom }}</td>
                </tr>

                @foreach ($nhomDoiTuongs as $nhomDoiTuong)
                    <tr class="group-client">
                        <td>{{ $nhomDoiTuong->ma_doi_tuong }}</td>
                        <td>{{ $nhomDoiTuong->ten_nhom_doi_tuong }}</td>
                        <td>
                            {{ $nhomDoiTuong->loai_nhom_doi_tuong }}
                            <a href="{{ route('nhomdoituong.edit', $nhomDoiTuong->id) }}" class="create-link">
                                <i class="fa-solid fa-pen-to-square edit-icon"></i>
                            </a>
                            <!-- <form action="{{ route('nhomdoituong.destroy', $nhomDoiTuong->id) }}" method="POST"
                ...
                <tr class="group-footer">
                    <td colspan="3">Có {{ count($nhomDoiTuongs) }} loại {{ $loaiNhom }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
