...
@section('main')
<form id="create-form" action="{{ route('nhomdoituong.store') }}" method="POST">
    @csrf
    ...
    <table class="col-3-7">
        <tbody>
            ...
            <tr class="group-client">
                ...
                <td class="bottom">
                    <input type="text" name="ma_doi_tuong" placeholder="Nhập mã đối tượng" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Tên Nhóm Đối Tượng <span class="required">*</span></td>
                <td class="bottom">
                    <input type="text" name="ten_nhom_doi_tuong" placeholder="Nhập tên nhóm đối tượng" required>
                </td>
            </tr>
        </tbody>
    </table>
