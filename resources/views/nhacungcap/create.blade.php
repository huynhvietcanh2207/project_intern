    ...
    <table class="col-3-7">
        <tbody>
            <tr class="group-client">
                ...
                <div class="dropdown-container">
                    ...
                    <select name="group" id="group" class="form-control" required>
                        <option value="" disabled selected>Chọn Thông Tin</option>
            ...
            <tr class="group-client">
                ...
                <td class="bottom">
                    <input type="text" name="supplier_code" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Tên Nhà Cung Cấp <span class="required">*</span></td>
                <td class="bottom">
                    <input type="text" name="name" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Địa Chỉ</td>
                <td class="bottom">
                    <input type="text" name="address" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Điện Thoại</td>
                <td class="bottom">
                    <input type="text" name="phone" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Email</td>
                <td class="bottom">
                    <input type="text" name="email" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Mã Số Thuế</td>
                <td class="bottom">
                    <input type="text" name="tax_code" placeholder="Nhập thông tin" required>
                </td>
            </tr>
            <tr class="group-client">
                <td class="top">Ghi Chú</td>
                <td class="bottom">
                    <input type="text" name="notes" placeholder="Nhập thông tin" required>
                </td>
            </tr>
        </tbody>
    </table>
