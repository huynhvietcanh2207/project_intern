    ...
    <div class="items-header">
        ...
        <div class="search-wrapper">
            <div class="search">
                <form action="{{ route('kho.index') }}" method="GET">
                    ...
                    <input type="text" name="search" placeholder="Tìm kiếm kho" class="search-bar"
        ...
        <div class="create-btn-wrapper">
            <button class="create-btn">
                <a href="{{ route('kho.create') }}" class="create-link">
    ...
    <table>
        ...
        <tbody>
            @foreach($warehouses as $index => $warehouse)
                <tr class="group-client">
                    ...
                    <td>{{ $warehouse->address }}
                        <a href="{{ route('kho.edit', $warehouse->id) }}">
            ...
            <tr class="group-footer">
                <td colspan="6">Có {{ $warehouses->count() }} kho</td>
            </tr>
        </tbody>
