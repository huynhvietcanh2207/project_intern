...
<div class="containerr">
    ...
    <form>
        <div class="form-row">
            ...
            <div class="form-group">
                <label for="phuong-thuc-tra-hang">Phương thức trả hàng <span class="required">*</span></label>
                <select id="phuong-thuc-tra-hang">
                    <option value="">-- Chọn thông tin --</option>
        ...
        <table class="item-table">
            <thead>
                <tr>
                    ...
                    <th>Serial Number</th>
                    <th>Mã hàng đổi</th>
                    <th>Serial Number đổi</th>
                    <th>Ghi chú</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="8" class="add-product">
