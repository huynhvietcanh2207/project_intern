...
<section>
    ...
    <div class="items-header">
        ...
        <div class="search-wrapper">
            <div class="search">
                <form action="{{ route('hanghoa.index') }}" method="GET">
                    <i class="fa-solid fa-magnifying-glass search-icon"></i>
                    <input type="text" name="search" placeholder="Tìm kiếm sản phẩm" class="search-bar"
        ...
        <div class="create-btn-wrapper">
            <button class="create-btn">
                <a href="{{ route('hanghoa.create') }}" class="create-link">
        ...
        <tbody>
            @foreach ($products as $group => $items)
                <tr class="group-header">
                    <td colspan="4">Nhóm Hàng Hóa: {{ $group }}</td>
                </tr>
                @foreach ($items as $product)
                    <tr class="group-client">
                        ...
                        <td>{{ $product->name }}</td>
                        <td>{{ $product->brand }}</td>
                        <td>{{ $product->warranty_period }} Tháng
                            <a href="{{ route('hanghoa.edit', $product->id) }}">
                ...
                <tr class="group-footer">
                    <td colspan="4">SL Hàng Hóa: {{ $items->count() }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
