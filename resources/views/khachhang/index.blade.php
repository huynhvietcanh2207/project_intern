...
<section>
    ...
    <div class="items-header">
        ...
        <div class="search-wrapper">
            <div class="search">
                <form action="{{ route('khachhang.index') }}" method="GET">
                    ...
                    <input type="text" name="search" placeholder="Tìm kiếm" class="search-bar"
        ...
        <div class="create-btn-wrapper">
            <button class="create-btn">
                <a href="{{ route('khachhang.create') }}" class="create-link">
    ...
    <table>
        ...
        <tbody>
            @foreach($customers as $group => $groupCustomers)
                ...
                @foreach($groupCustomers as $customer)
                    <tr class="group-client">
                        ...
                        <td>{{ $customer->note }}
                            <a href="{{ route('khachhang.edit', $customer->id) }}">
                ...
                <tr class="group-footer">
                    <td colspan="6">Có {{ $groupCustomers->count() }} khách hàng</td>
                </tr>
            @endforeach
        </tbody>
    </table>
